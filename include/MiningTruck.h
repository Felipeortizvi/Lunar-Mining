...
public:
    ...
    // Adds to this truck's total mining time (in min).
    void AddMiningTime_(int minutes);

    // Adds to this truck's total travel time (in min).
    void AddTravelTime_(int minutes);

    // Adds to this truck's total waiting time (in min).
    void AddWaitingTime_(int minutes);

    // Adds to this truck's total unloading time (in min).
